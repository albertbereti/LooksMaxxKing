...
export const PaywallModal: React.FC<PaywallModalProps> = ({ onClose, onPurchase, isProcessing }) => (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
        ...
        <div className="relative bg-zinc-900 w-full max-w-md rounded-3xl overflow-hidden border border-amber-500/30 shadow-[0_0_50px_rgba(245,158,11,0.2)] animate-fade-in-up">
            <div className="bg-gradient-to-r from-amber-500 to-yellow-600 p-6 text-center relative overflow-hidden">
...
export const TopUpModal: React.FC<TopUpModalProps> = ({ onClose, onPurchase, isProcessing }) => (
    <div className="fixed inset-0 z-[85] flex items-center justify-center p-4">
            <div className="absolute inset-0 bg-black/80 backdrop-blur-md" onClick={onClose}></div>
            <div className="relative bg-zinc-900 w-full max-w-sm rounded-3xl overflow-hidden border border-blue-500/30 shadow-2xl animate-fade-in-up p-6 text-center">
