              ...
              <div className="p-6 bg-zinc-900 rounded-3xl border border-white/5 mb-4">
                ...
                <div className="mt-6 pt-4 border-t border-white/5">
                  {user?.email ? (
                    ...
                    <button onClick={() => metrics.login()} className="w-full py-3 bg-white text-black rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-zinc-200 transition-colors flex items-center justify-center gap-2">
